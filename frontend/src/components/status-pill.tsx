...
const toneByStatus: Record<string, string> = {
  ...
  new_opportunity: "bg-sky-50 text-sky-700 ring-sky-200",
  high_match: "bg-emerald-50 text-emerald-700 ring-emerald-200",
  deadline_approaching: "bg-amber-50 text-amber-700 ring-amber-200",
  missing_document: "bg-red-50 text-red-700 ring-red-200",
  essay_ready: "bg-violet-50 text-violet-700 ring-violet-200",
  recommendation_ready: "bg-blue-50 text-blue-700 ring-blue-200",
  email_draft_ready: "bg-sky-50 text-sky-700 ring-sky-200",
