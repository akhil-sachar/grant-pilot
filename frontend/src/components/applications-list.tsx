...
import type { GrantApplication, Opportunity } from "@/lib/types";
...
export function ApplicationsList({
  ...
  if (!applications.length) {
    return (
      <section className="rounded-lg border border-dashed border-line bg-panel p-8 text-center text-sm text-muted shadow-soft">
        No applications yet. Create one from a matched opportunity above.
      </section>
    );
  }
