...
from app.models import APIModel, AgentActionLog, AgentActionStatus, EmailType, OutreachEmail, OutreachEmailStatus, RecipientRole
...
class OutreachAgent(BaseAgent):
    ...
    async def generate_for_application(
        ...
        action_log = AgentActionLog(
            ...
            input_summary=f"Outreach for application {application_id}",
            metadata={
