...
def build_seed_data() -> dict[str, list[dict]]:
    ...
    outreach_emails = [
        OutreachEmail(
            ...
            recipient_role=RecipientRole.PROFESSOR,
            email_type=EmailType.RECOMMENDATION_REQUEST,
    ...
    notifications = [
        Notification(
            ...
            created_at=_dt("2026-06-12T09:00:00"),
        ),
        Notification(
            id="not_deadline_open_grant",
            user_id=DEFAULT_USER_ID,
            title="Deadline approaching",
            message="Open Data Research Grant is due in 48 day(s).",
        ...
        Notification(
            ...
            created_at=_dt("2026-06-11T11:00:00"),
        ),
        Notification(
            id="not_rec_ready",
            user_id=DEFAULT_USER_ID,
            ...
            created_at=_dt("2026-06-10T13:00:00"),
        ),
        Notification(
            id="not_email_ready",
            user_id=DEFAULT_USER_ID,
            ...
            created_at=_dt("2026-06-10T14:00:00"),
        ),
    ]
    ...
    agent_action_logs = [
        AgentActionLog(
            ...
            created_at=_dt("2026-06-12T08:00:00"),
        ),
        AgentActionLog(
            id="log_matching_run",
            user_id=DEFAULT_USER_ID,
            ...
            created_at=_dt("2026-06-12T08:01:30"),
        ),
        AgentActionLog(
            ...
            metadata={
                ...
                "runtime_ms": 1240,
                "application_id": "app_civic_ai",
                "essay_version_id": "essay_civic_ai_v1",
                "tracked_by": "guild-ai",
            },
            created_at=_dt("2026-06-12T08:03:00"),
        ),
        AgentActionLog(
            id="log_rec_draft",
            user_id=DEFAULT_USER_ID,
            ...
            created_at=_dt("2026-06-12T08:04:15"),
        ),
        AgentActionLog(
            id="log_outreach",
            user_id=DEFAULT_USER_ID,
            ...
            created_at=_dt("2026-06-12T08:05:30"),
        ),
        AgentActionLog(
            ...
            created_at=_dt("2026-06-12T08:06:00"),
        ),
        AgentActionLog(
            id="log_composio",
            user_id=DEFAULT_USER_ID,
            ...
            created_at=_dt("2026-06-12T08:05:45"),
        ),
    ]
